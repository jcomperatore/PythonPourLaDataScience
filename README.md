...
<div style="overflow : auto;">
    <img src = 'Mots sans clean.png' width = 50% style="float: right; margin-left: 20px; width: 50%;">
    Une fois toutes ces données récupérées, il est nécessaire de les traiter pour pouvoir les exploiter par la suite. En effet, on s'aperçoit assez vite que les textes sont trop pollués. 
</div>
<\!-->
